...
//GEN-LINE:|4-resumeMIDlet|1|4-postAction
    ...
    public StringItem getStringItem() {
        if (stringItem == null) {//GEN-END:|16-getter|0|16-preInit
            // write pre-init user code here
            stringItem = new StringItem("Hello", "Hello, World!");//GEN-BEGIN:|16-getter|1|16-postInit
    ...
    public StringItem getStringItem1() {
        if (stringItem1 == null) {//GEN-END:|22-getter|0|22-preInit
            // write pre-init user code here
            stringItem1 = new StringItem("stringItem1", null, Item.PLAIN);//GEN-BEGIN:|22-getter|1|22-postInit
            stringItem1.setFont(getFont());//GEN-END:|22-getter|1|22-postInit
            // write post-init user code here
    ...
    //<editor-fold defaultstate="collapsed" desc=" Generated Getter: font ">//GEN-BEGIN:|23-getter|0|23-preInit
    /**
     * Returns an initiliazed instance of font component.
     * @return the initialized component instance
     */
    public Font getFont() {
        if (font == null) {//GEN-END:|23-getter|0|23-preInit
            // write pre-init user code here
            font = Font.getFont(Font.FACE_SYSTEM, Font.STYLE_BOLD, Font.SIZE_LARGE);//GEN-LINE:|23-getter|1|23-postInit
            // write post-init user code here
